...
public class NotificationManager {
	 ...
	 *            the uri
	 */
	public void sendNotifcationToUser(String id, String apiKey,
			String username, String title, String message, String uri,
			boolean shouldsave) {
	...
	public void sendNotificatoionByAlias(String alias, String apiKey,
		...
		if (username != null) {
			String id = String.valueOf(new Date().getTime());
			sendNotifcationToUser(id, apiKey, username, title, message, uri,
					shouldsave);
		}
	}
	...
	public void sendNotificationByTag(String tag, String apiKey, String title,
		...
		if (usernameSet != null && usernameSet.size() > 0) {
			for (String username : usernameSet) {
				String id = String.valueOf(new Date().getTime());
				sendNotifcationToUser(id, apiKey, username, title, message,
						uri, shouldsave);
			}
		}
	}
